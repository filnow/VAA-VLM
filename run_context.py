            ...
            conversation = [
                ...
                {"role": "assistant", "content": assistant_content},
                {
                    ...
                    "content": [
                        ...
                        {"type": "text", "text": safe_template.format(**combined_context)}
                    ]
                }
            ]
    ...
    def rate_emotions(
        ...
        for item in tqdm(dataset, desc="Processing images"):
            ...
            for participant_id, participant_context in participant_contexts.items():
                ...
                prompts = self._create_prompts_for_image(
                    base64_image,
                    emotion_definitions,
                    prompt_context
                )
                ...
                parsed_scores = self._parse_emotion_scores(raw_content[:-1], expected_count)
...
@hydra.main(version_base=None, config_path="configs", config_name="config-context")
